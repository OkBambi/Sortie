...
public class PlayerMovement : MonoBehaviour, ICharacterController, IResourceProvider
{
    ...
    public void UpdateInput(CharacterInput input)
    {
        ...
        // Fire Boost Events for AudioManager
    ...
    public void UpdateBody(float deltaTime)
    {
        ...
        else { _currentDashRecovery = Stats.DashRecoveryTime; }
    ...
    int IResourceProvider.GetResourceCurrent(ResourceType type) => throw new NotImplementedException();
    int IResourceProvider.GetResourceMax(ResourceType type) => throw new NotImplementedException();
    public bool HasResource(ResourceType type) => type == ResourceType.Boost;
}